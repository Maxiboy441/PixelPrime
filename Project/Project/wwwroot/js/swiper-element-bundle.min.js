...
!function () {
    ...
    function z(e) {
        return void 0 === e && (e = {}), C || (C = function (e) {
            ...
            const s = L(), i = r(), a = i.navigator.platform, n = t || i.navigator.userAgent,
    ...
    function k() {
        return P || (P = function () {
            ...
            const a = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(e.navigator.userAgent), n = i();
    ...
    var G = {
        updateSize: function () {
            ...
            const s = e.params, { wrapperEl: i, slidesEl: a, size: r, rtlTranslate: n, wrongRTL: l } = e,
                o = e.virtual && s.virtual.enabled, d = o ? e.virtual.slides.length : e.slides.length,
                p = f(a, `.${e.params.slideClass}, swiper-slide`), c = o ? e.virtual.slides.length : p.length;
            let m = [];
            const h = [], g = [];
            ...
            for (let i = 0; i < c; i += 1) {
                ...
                if (L = 0, p[i] && (a = p[i]), P && e.grid.updateSlide(i, a, p), !p[i] || "none" !== b(a, "display")) {
                    if ("auto" === s.slidesPerView) {
                        ...
                        if (n && (a.style.transform = "none"), l && (a.style.webkitTransform = "none"), s.roundLengths) L = e.isHorizontal() ? S(a, "width", !0) : S(a, "height", !0); else {
            ...
            if (c !== d && e.emit("slidesLengthChange"), m.length !== y && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== x && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(o || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                f && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e)), I(o, f, s.slideVisibleClass), I(o, h, s.slideFullyVisibleClass), o.progress = a ? -p : p, o.originalProgress = a ? -c : c
            }
            ...
            const e = this, { slides: t, params: s, slidesEl: i, activeIndex: a } = e, r = e.virtual && s.virtual.enabled,
                n = e.grid && s.grid && s.grid.rows > 1, l = e => f(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
            let o, d, p;
            if (r) if (s.loop) {
                let t = a - e.virtual.slidesBefore;
                t < 0 && (t = e.virtual.slides.length + t), t >= e.virtual.slides.length && (t -= e.virtual.slides.length), o = l(`[data-swiper-slide-index="${t}"]`)
            } else o = l(`[data-swiper-slide-index="${a}"]`); else n ? (o = t.filter((e => e.column === a))[0], p = t.filter((e => e.column === a + 1))[0], d = t.filter((e => e.column === a - 1))[0]) : o = t[a];
            o && (n || (p = function (e, t) {
                const s = [];
                ...
                return s
            }(o, `.${s.slideClass}, swiper-slide`)[0], s.loop && !p && (p = t[0]), d = function (e, t) {
                const s = [];
                ...
                $(e, e === o, s.slideActiveClass), $(e, e === p, s.slideNextClass), $(e, e === d, s.slidePrevClass)
            })), e.emitSlidesClasses()
            ...
            Object.assign(t, {
                ...
                previousIndex: r,
                activeIndex: d
            }), t.initialized && _(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (n !== u && t.emit("realIndexChange"), t.emit("slideChange"))
    ...
    var R = {
        loopCreate: function (e) {
            ...
            if (o.__preventObserver__ = !0, requestAnimationFrame((() => {
                ...
                if (void 0 === t) {
                    const e = o.slidesGrid[E], t = o.slidesGrid[E + M] - e;
                ...
                const e = o.slidesGrid[E], t = o.slidesGrid[E - C] - e;
    ...
    function Y(e) {
        ...
        const u = !!l.noSwipingClass && "" !== l.noSwipingClass, m = a.composedPath ? a.composedPath() : a.path;
    ...
    function F(e) {
        const t = i(), s = this, a = s.touchEventsData, { params: r, touches: n, rtlTranslate: l, enabled: d } = s;
        if (!d) return;
        ...
        if (a.isScrolling && s.emit("touchMoveOpposite", c), void 0 === a.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (a.startMoving = !0)), a.isScrolling || "touchmove" === c.type && a.preventTouchMoveFromPointerMove) return void (a.isTouched = !1);
    ...
    function q(e) {
        ...
        const y = (h - p[g]) / v, x = g < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
        if (m > r.longSwipesMs) {
    ...
    const Z = (e, t) => {
        ...
        r && "string" != typeof r && (s[d]("touchstart", e.onDocumentTouchStart, {
            ...
            passive: !1,
            capture: o
        }), s[d]("touchend", e.onTouchEnd, { passive: !0 }), s[d]("pointerup", e.onTouchEnd, { passive: !0 }), s[d]("pointercancel", e.onTouchEnd, { passive: !0 }), s[d]("touchcancel", e.onTouchEnd, { passive: !0 }), s[d]("pointerout", e.onTouchEnd, { passive: !0 }), s[d]("pointerleave", e.onTouchEnd, { passive: !0 }), s[d]("contextmenu", e.onTouchEnd, { passive: !0 }), (a.preventClicks || a.preventClicksPropagation) && r[d]("click", e.onClick, !0), a.cssMode && n[d]("scroll", e.onScroll), a.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", V, !0) : e[p]("observerUpdate", V, !0), r[d]("load", e.onLoad, { capture: !0 }))
    };
    ...
    const te = {
        eventsEmitter: A, update: G, translate: N, transition: {
            ...
            attachEvents: function () {
                ...
                e.onTouchStart = Y.bind(e), e.onTouchMove = F.bind(e), e.onTouchEnd = q.bind(e), e.onDocumentTouchStart = K.bind(e), t.cssMode && (e.onScroll = W.bind(e)), e.onClick = j.bind(e), e.onLoad = U.bind(e), Z(e, "on")
            ...
            setBreakpoint: function () {
                ...
                const l = (n in r ? r[n] : void 0) || e.originalParams, o = Q(e, i), d = Q(e, l),
                    p = e.params.grabCursor, u = l.grabCursor, m = i.enabled;
                ...
                const h = l.direction && l.direction !== i.direction,
                    f = i.loop && (l.slidesPerView !== i.slidesPerView || h), g = i.loop;
    ...
    class ie {
        constructor() {
            ...
            const l = this;
            l.__swiper__ = !0, l.support = L(), l.device = z({ userAgent: t.userAgent }), l.browser = k(), l.eventsListeners = {}, l.eventsAnyListeners = [], l.modules = [...l.__modules__], t.modules && Array.isArray(t.modules) && l.modules.push(...t.modules);
            const o = {};
            l.modules.forEach((e => {
                e({
                    params: t,
            ...
            const d = c({}, J, o);
            return l.params = c({}, d, se, t), l.originalParams = c({}, l.params), l.passedParams = c({}, t), l.params && l.params.on && Object.keys(l.params.on).forEach((e => {
        ...
        getSlideIndex(e) {
            const { slidesEl: t, params: s } = this, i = y(f(t, `.${s.slideClass}, swiper-slide`)[0]);
            return y(e) - i
        }
    ...
    function he(e, t, s) {
        const i = `swiper-slide-shadow${s ? `-${s}` : ""}${e ? ` swiper-slide-shadow-${e}` : ""}`, a = h(t);
    ...
    const fe = [function (e) {
        ...
        function p(e, t) {
            ...
            let b, y, x;
            b = s.rtlTranslate ? "right" : s.isHorizontal() ? "left" : "top", r ? (y = Math.floor(i / 2) + a + c, x = Math.floor(i / 2) + a + p) : (y = i + (a - 1) + c, x = (l ? i : a) + p);
            let E = w - x, S = w + y;
            ...
            if (l && w >= x ? (E -= x, r || (T += s.slidesGrid[0])) : l && w < x && (E = -x, r && (T += s.slidesGrid[0])), Object.assign(s.virtual, {
                from: E,
                to: S,
                offset: T,
                ...
                slidesBefore: x,
                slidesAfter: y
            }), u === E && m === S && !e) return s.slidesGrid !== g && T !== v && s.slides.forEach((e => {
            ...
            for (let t = z; t < k; t += 1) if (t >= E && t <= S) {
                const s = L(t);
        ...
        s({
            ...
            if (t.params.navigation.hideOnClick && !l) {
                ...
                let e;
                i.length ? e = i[0].classList.contains(t.params.navigation.hiddenClass) : r.length && (e = r[0].classList.contains(t.params.navigation.hiddenClass)), a(!0 === e ? "navigationShow" : "navigationHide"), [...i, ...r].filter((e => !!e)).forEach((e => e.classList.toggle(t.params.navigation.hiddenClass)))
            }
        }));
        const u = () => {
        ...
        function c() {
            ...
            if (t.params.loop ? (r = t.previousRealIndex || 0, i = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (i = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, i = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                let o, c, u;
                if (s.dynamicBullets && (n = S(a[0], t.isHorizontal() ? "width" : "height", !0), p.forEach((e => {
            ...
            p.forEach(((e, r) => {
                if ("fraction" === s.type && (e.querySelectorAll(re(s.currentClass)).forEach((e => {
                    ...
                    const r = (i + 1) / u;
                    let n = 1, l = 1;
                    "horizontal" === a ? n = r : l = r, e.querySelectorAll(re(s.progressbarFillClass)).forEach((e => {
        ...
        function S(e) {
            ...
            m && (e.preventDefault && e.cancelable ? e.preventDefault() : e.returnValue = !1, x(e), i.style.transitionDuration = "0ms", a.style.transitionDuration = "0ms", n.style.transitionDuration = "0ms", r("scrollbarDragMove", e))
        }

        function M(e) {
            const s = t.params.scrollbar, { scrollbar: i, wrapperEl: a } = t, { el: n } = i;
        ...
        function P() {
            ...
            t.params.uniqueNavElements && "string" == typeof i.el && a.length > 1 && 1 === s.querySelectorAll(i.el).length && (a = s.querySelector(i.el)), a.length > 0 && (a = a[0]), a.classList.add(t.isHorizontal() ? i.horizontalClass : i.verticalClass), a && (r = a.querySelector(re(t.params.scrollbar.dragClass)), r || (r = v("div", t.params.scrollbar.dragClass), a.append(r))), Object.assign(e, {
                el: a,
                dragEl: r
            }), i.draggable && t.params.scrollbar.el && t.scrollbar.el && C("on"), a && a.classList[t.enabled ? "remove" : "add"](...n(t.params.scrollbar.lockClass))
        }
        ...
        }), t.scrollbar = { el: null, dragEl: null }, a("changeDirection", (() => {
        ...
        Object.assign(t.scrollbar, {
            ...
            }, disable: z, updateSize: b, setTranslate: g, init: P, destroy: L
        })
    }, function (e) {
        ...
        const a = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
            r = (e, s) => {
                ...
                const { el: e, slides: s, progress: i, snapGrid: n, isElement: l } = t, o = f(e, a);
        ...
        function M(e) {
            ...
            a >= 0 && (u[a] = e), u.length < 2 || (o = !0, m.scaleMove = y(), m.imageEl && (i.scale = m.scaleMove / m.scaleStart * p, i.scale > m.maxRatio && (i.scale = m.maxRatio - 1 + (i.scale - m.maxRatio + 1) ** .5), i.scale < s.minRatio && (i.scale = s.minRatio + 1 - (s.minRatio - i.scale + 1) ** .5), m.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`))
        }
        ...
        function O() {
            ...
            t.wrapperEl.addEventListener("pointerdown", T, s), t.wrapperEl.addEventListener("pointermove", M, i), ["pointerup", "pointercancel", "pointerout"].forEach((e => {
        ...
        function D() {
            ...
            e.enabled = !1;
            const { passiveListener: s, activeListenerWithCapture: i } = $();
            t.wrapperEl.removeEventListener("pointerdown", T, s), t.wrapperEl.removeEventListener("pointermove", M, i), ["pointerup", "pointercancel", "pointerout"].forEach((e => {
        ...
        function w(e) {
            ...
            if (!t.pagination || !t.pagination.el || i !== t.pagination.el && !t.pagination.el.contains(e.target) || e.target.matches(re(t.params.pagination.bulletClass))) {
                if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
                    ...
                    T(t.navigation.nextEl).includes(i) && (t.isEnd && !t.params.loop || t.slideNext(), t.isEnd ? d(s.lastSlideMessage) : d(s.nextSlideMessage)), e.includes(i) && (t.isBeginning && !t.params.loop || t.slidePrev(), t.isBeginning ? d(s.firstSlideMessage) : d(s.prevSlideMessage))
                }
        ...
        const E = (e, t, s) => {
            p(e), "BUTTON" !== e.tagName && (u(e, "button"), e.addEventListener("keydown", w)), h(e, s), function (e, t) {
                (e = T(e)).forEach((e => {
            ...
            i || a || e.sourceCapabilities && e.sourceCapabilities.firesTouchEvents || (t.isHorizontal() ? t.el.scrollLeft = 0 : t.el.scrollTop = 0, requestAnimationFrame((() => {
            ...
            if (p = T(p), c = T(c), p && p.forEach((t => E(t, r, e.nextSlideMessage))), c && c.forEach((t => E(t, r, e.prevSlideMessage))), x()) {
                T(t.pagination.el).forEach((e => {
                    e.addEventListener("keydown", w)
                }))
            }
            i().addEventListener("visibilitychange", C), t.el.addEventListener("focus", P, !0), t.el.addEventListener("focus", P, !0), t.el.addEventListener("pointerdown", S, !0), t.el.addEventListener("pointerup", M, !0)
        };
        a("beforeInit", (() => {
            ...
            t.params.a11y.enabled && function () {
                ...
                b() && t.pagination.bullets.forEach((s => {
                    t.params.pagination.clickable && (p(s), t.params.pagination.renderBullet || (u(s, "button"), h(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, y(s) + 1)))), s.matches(re(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                }))
            }()
        })), a("destroy", (() => {
            t.params.a11y.enabled && function () {
                ...
                e = T(e), s = T(s), e && e.forEach((e => e.removeEventListener("keydown", w))), s && s.forEach((e => e.removeEventListener("keydown", w))), x() && T(t.pagination.el).forEach((e => {
                    e.removeEventListener("keydown", w)
                }));
                i().removeEventListener("visibilitychange", C), t.el && "string" != typeof t.el && (t.el.removeEventListener("focus", P, !0), t.el.removeEventListener("pointerdown", S, !0), t.el.removeEventListener("pointerup", M, !0))
            }()
        }))
    }, function (e) {
        let { swiper: t, extendParams: s, on: i } = e;
        ...
        n("init", (() => {
            ...
            a.el && "string" != typeof a.el && (a.el.removeEventListener("pointerenter", L), a.el.removeEventListener("pointerleave", z)), i().removeEventListener("visibilitychange", P), a.autoplay.running && T()
        ...
        t.thumbs = { swiper: null }, a("beforeInit", (() => {
            ...
            if (e && e.swiper) if ("string" == typeof e.swiper || e.swiper instanceof HTMLElement) {
                const s = i(), a = () => {
                    ...
                    if (i && i.swiper) e.swiper = i.swiper, o(), d(!0); else if (i) {
                        const s = a => {
        ...
        l("init", (() => {
            ...
            initSlides: e => {
                ...
                const { slidesPerGroup: l } = r.params, d = o(), { rows: p, fill: c } = r.params.grid,
                    u = r.virtual && r.params.virtual.enabled ? r.virtual.slides.length : n.length;
                let m, h, f;
                if ("row" === c && l > 1) {
                    const s = Math.floor(e / (l * p)), i = e - p * l * s,
                ...
                const { centeredSlides: i, roundLengths: a } = r.params, n = o(), { rows: l } = r.params.grid;
        ...
        ce({
            ...
            setTranslate: () => {
                ...
                for (let e = 0; e < i.length; e += 1) {
                    ...
                    m <= 1 && m > -1 && (h = 90 * r + 90 * m, l && (h = 90 * -r - 90 * m), t.browser && t.browser.need3dFix && Math.abs(h) / 90 % 2 == 1 && (h += .001)), s.style.transform = w, p.slideShadows && a(s, m, c)
                }
                if (s.style.transformOrigin = `50% 50% -${o / 2}px`, s.style["-webkit-transform-origin"] = `50% 50% -${o / 2}px`, p.shadow) if (c) m.style.transform = `translate3d(0px, ${r / 2 + p.shadowOffset}px, ${-r / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${p.shadowScale})`; else {
        ...
        const a = (e, s) => {
            ...
            i || (i = he("flip", e, t.isHorizontal() ? "left" : "top")), a || (a = he("flip", e, t.isHorizontal() ? "right" : "bottom")), i && (i.style.opacity = Math.max(-s, 0)), a && (a.style.opacity = Math.max(s, 0))
        };
        ce({
            effect: "flip",
            swiper: t,
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < e.length; r += 1) {
                    ...
                    t.isHorizontal() ? s && (d = -d) : (u = c, c = 0, p = -d, d = 0), t.browser && t.browser.need3dFix && (Math.abs(d) / 90 % 2 == 1 && (d += .001), Math.abs(p) / 90 % 2 == 1 && (p += .001)), n.style.zIndex = -Math.abs(Math.round(l)) + e.length, i.slideShadows && a(n, l);
        ...
        s({ coverflowEffect: { rotate: 50, stretch: 0, depth: 100, scale: 1, modifier: 1, slideShadows: !0 } }), ce({
            effect: "coverflow", swiper: t, on: i, setTranslate: () => {
                ...
                for (let e = 0, s = i.length; e < s; e += 1) {
                    const s = i[e], l = a[e], c = (o - s.swiperSlideOffset - l / 2) / l,
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < e.length; o += 1) {
                    ...
                    if (a.slideShadows) {
                        ...
                        e || (e = he("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1))
                    }
    ...
    function we(e, t) {
        ...
        Object.keys(t).filter((e => s.indexOf(e) < 0)).forEach((s => {
            void 0 === e[s] ? e[s] = t[s] : ve(t[s]) && ve(e[s]) && Object.keys(t[s]).length > 0 ? t[s].__swiper__ ? e[s] = t[s] : we(e[s], t[s]) : e[s] = t[s]
        }))
    }
    ...
    const ye = e => {
        ...
        xe = ["a11y", "autoplay", "controller", "cards-effect", "coverflow-effect", "creative-effect", "cube-effect", "fade-effect", "flip-effect", "free-mode", "grid", "hash-navigation", "history", "keyboard", "mousewheel", "navigation", "pagination", "parallax", "scrollbar", "thumbs", "virtual", "zoom"];

    function Ee(e, t, s) {
        const i = {}, a = {};
        we(i, J);
        const r = [...ge, "on"], n = r.map((e => e.replace(/_/, "")));
        r.forEach((t => {
            t = t.replace("_", ""), void 0 !== e[t] && (a[t] = e[t])
        }));
        const l = [...e.attributes];
        return "string" == typeof t && void 0 !== s && l.push({ name: t, value: ve(s) ? { ...s } : s }), l.forEach((e => {
            const t = xe.filter((t => 0 === e.name.indexOf(`${t}-`)))[0];
            if (t) {
                const s = be(t), i = be(e.name.split(`${t}-`)[1]);
        ...
        })), we(i, a), i.navigation ? i.navigation = {
            prevEl: ".swiper-button-prev",
    ...
    class Pe extends Te {
        ...
        calcSlideSlots() {
            ...
            if (this.slideSlots = t.length ? Math.max(...t) + 1 : 0, this.rendered) if (this.slideSlots > e) for (let t = e; t < this.slideSlots; t += 1) {
        ...
        render() {
            ...
            this.slideSlots > 0 && (e = e.replace(/::slotted\(([a-z-0-9.]*)\)/g, "$1")), e.length && Ce(this.shadowRoot, e), this.cssLinks().forEach((e => {
        ...
        initialize() {
            ...
            this.swiperParams = t, this.passedParams = s, delete this.swiperParams.init, this.render(), this.swiper = new ie(this.shadowRoot.querySelector(".swiper"), {
                ...t.virtual ? {} : {
                    observer: !0,
        ...
        updateSwiperOnPropChange(e, t) {
            ...
            this.passedParams = i, this.swiperParams = s, this.swiper && this.swiper.params[e] === t || function (e) {
                ...
                a.includes("loop") && t.isElement && (p.loop && !i.loop ? x = !0 : !p.loop && i.loop ? E = !0 : S = !0), d.forEach((e => {
                    if (ve(p[e]) && ve(i[e])) Object.assign(p[e], i[e]), "navigation" !== e && "pagination" !== e && "scrollbar" !== e || !("enabled" in i[e]) || i[e].enabled || T(e); else {
                        const t = i[e];
                ...
                changedParams: [be(e)], ..."navigation" === e && i[e] ? {
                    prevEl: ".swiper-button-prev",
                    nextEl: ".swiper-button-next"
        ...
        static get observedAttributes() {
            return ge.filter((e => e.includes("_"))).map((e => e.replace(/[A-Z]/g, (e => `-${e}`)).replace("_", "").toLowerCase()))
        }
    }

    ge.forEach((e => {
        "init" !== e && (e = e.replace("_", ""), Object.defineProperty(Pe.prototype, e, {
            configurable: !0, get() {
    ...
    "undefined" != typeof window && (window.SwiperElementRegisterParams = e => {
        ge.push(...e)
    }), "undefined" != typeof window && (window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Pe), window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", Le))
}();
